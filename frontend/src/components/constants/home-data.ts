...
export const faqs = [
  {
    ...
    a: "CodeGrowthKh គឺជាវេបសាយសិក្សាសរសេរកូដ (programming) ដែលផ្តល់នូវមេរៀន និងឧទាហរណ៍កូដជាភាសាខ្មែរ។ វាជួយអ្នកសិក្សាខ្មែរ ដែលអាចមានការលំបាកក្នុងការសិក្សាជាភាសាអង់គ្លេស ដោយផ្តល់មេរៀនសាមញ្ញ និងងាយយល់។ វេបសាយនេះមានមេរៀនស្តីពី HTML, CSS, JavaScript, Python, Dart, C++, និងភាសាសរសេរកូដផ្សេងទៀត។",
  },
  {
